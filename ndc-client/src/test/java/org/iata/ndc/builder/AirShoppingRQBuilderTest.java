...
public class AirShoppingRQBuilderTest {
	...
	public void oneAnonymousAdult() {
		...
		TravelersTraveler gt = travelers.get(0);
		assertEquals(1, gt.getAnonymousTraveler().size());
		PTC ptc = gt.getAnonymousTraveler().get(0).getPTC();
	...
	public void multipleAnonymousTravellers() {
		...
		assertEquals(1, travelers.size());
		TravelersTraveler gt = travelers.get(0);
		assertEquals(3, gt.getAnonymousTraveler().size());
		for (AnonymousTravelerType t : gt.getAnonymousTraveler()) {
	...
	public void noPreferences() {
		AirShoppingRQ request = testedClass.build();
		assertNull(request.getPreference());
	}
	...
	public void addAirlinePreference() {
		...
		assertNotNull(request.getPreference());
		AirlinePreferencesType airlinePreference = request.getPreference().getAirlinePreferences();
	...
	public void addFarePreference() {
		...
		assertNotNull(request.getPreference());
		FarePreferencesType farePreference =  request.getPreference().getFarePreferences();
	...
	public void addCabinPreference() {
		...
		assertNotNull(request.getPreference());
		CabinPreferencesType cabinPreference = request.getPreference().getCabinPreferences();
