...
public class NdcClientIT {
	...
	private static AirShoppingRS airShoppingRS;
	...
	public void d_builtAirShoppingRQ() {
		...
		AirShoppingRQ request = new AirShoppingRQBuilder()
				.setParty(party)
				.addOriginDestination("LHR", "CDG", date, 3, 3)
	...
	public void e_builtSeatAvailabilityRQ() {
		DataLists lists = airShoppingRS.getDataLists();
	...
	public void f_serviceListRQ() {
		String orderID = "A12345QH8";
		String owner = "C9";
		ServiceListRQ request = new ServiceListRQBuilder()
				.setParty(party)
				.setOrderID(orderID, owner)
				.build();
