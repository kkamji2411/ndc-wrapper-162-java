...
public class OrdChangeMetadataType {
    ...
    protected List<OrdChangeMetadataType.OtherMetadata> other;
    ...
    public List<OrdChangeMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<OrdChangeMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<OrdChangeMetadataType.OtherMetadata> other) {
        this.other = other;
    }
