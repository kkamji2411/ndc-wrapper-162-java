 ...
 *           &lt;complexType&gt;
 *             &lt;simpleContent&gt;
 *               &lt;extension base="&lt;http://www.iata.org/IATA/EDIST&gt;RuleStatusSimpleType"&gt;
 *               &lt;/extension&gt;
 *             &lt;/simpleContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                           &lt;sequence&gt;
 *                             &lt;element ref="{http://www.iata.org/IATA/EDIST}NodePath" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends MetadataObjectBaseType
{
    ...
    protected List<RuleMetadataType.Value> values;
    ...
    public List<RuleMetadataType.Value> getValues() {
        if (values == null) {
            values = new ArrayList<RuleMetadataType.Value>();
        }
        return values;
    }

    public void setValues(List<RuleMetadataType.Value> values) {
        this.values = values;
    }
    ...
    public static class Value {
        ...
        protected RuleMetadataType.Value.Instruction instruction;
         ...
         * @return
         *     possible object is
         *     {@link RuleMetadataType.Value.Instruction }
         *     
         */
        public RuleMetadataType.Value.Instruction getInstruction() {
            return instruction;
        }
         ...
         *     
         */
        public void setInstruction(RuleMetadataType.Value.Instruction value) {
