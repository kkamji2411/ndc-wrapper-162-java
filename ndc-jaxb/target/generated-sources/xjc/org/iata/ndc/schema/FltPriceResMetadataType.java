...
@XmlSeeAlso({
    org.iata.ndc.schema.FlightPriceRS.Metadata.class
})
public class FltPriceResMetadataType {
    ...
    protected List<FltPriceResMetadataType.OtherMetadata> other;
    ...
    public List<FltPriceResMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<FltPriceResMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<FltPriceResMetadataType.OtherMetadata> other) {
        this.other = other;
    }
