...
@XmlSeeAlso({
    org.iata.ndc.schema.ServiceListRS.Metadata.class
})
public class SrvListResMetadataType {
    ...
    protected SrvListResMetadataType.Traveler traveler;
    @XmlElementWrapper(name = "Other")
    @XmlElement(name = "OtherMetadata", namespace = "http://www.iata.org/IATA/EDIST")
    protected List<SrvListResMetadataType.OtherMetadata> other;
     ...
     * @return
     *     possible object is
     *     {@link SrvListResMetadataType.Traveler }
     *     
     */
    public SrvListResMetadataType.Traveler getTraveler() {
        return traveler;
    }
     ...
     *     
     */
    public void setTraveler(SrvListResMetadataType.Traveler value) {
        this.traveler = value;
    }

    public List<SrvListResMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<SrvListResMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<SrvListResMetadataType.OtherMetadata> other) {
        this.other = other;
    }
