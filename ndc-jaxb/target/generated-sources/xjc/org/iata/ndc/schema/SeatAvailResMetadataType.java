...
public class SeatAvailResMetadataType {
    ...
    protected SeatAvailResMetadataType.Traveler traveler;
    @XmlElementWrapper(name = "Other")
    @XmlElement(name = "OtherMetadata", namespace = "http://www.iata.org/IATA/EDIST")
    protected List<SeatAvailResMetadataType.OtherMetadata> other;
     ...
     * @return
     *     possible object is
     *     {@link SeatAvailResMetadataType.Traveler }
     *     
     */
    public SeatAvailResMetadataType.Traveler getTraveler() {
        return traveler;
    }
     ...
     *     
     */
    public void setTraveler(SeatAvailResMetadataType.Traveler value) {
        this.traveler = value;
    }

    public List<SeatAvailResMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<SeatAvailResMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<SeatAvailResMetadataType.OtherMetadata> other) {
        this.other = other;
    }
