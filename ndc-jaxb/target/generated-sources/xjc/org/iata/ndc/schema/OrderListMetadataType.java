 ...
 * Metadata definition.
 * 
 * <p>Java class for OrderListMetadataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OrderListMetadataType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "OrderListMetadataType", propOrder = {
    "passengerMetadata",
    "other"
})
public class OrderListMetadataType {
    ...
    protected List<OrderListMetadataType.OtherMetadata> other;
    ...
    public List<OrderListMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<OrderListMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<OrderListMetadataType.OtherMetadata> other) {
        this.other = other;
    }
