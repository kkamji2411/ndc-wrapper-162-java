...
public class SeatAvailabilityRS {
    ...
    protected List<SeatAvailabilityRS.Service> services;
    ...
    public List<SeatAvailabilityRS.Service> getServices() {
        if (services == null) {
            services = new ArrayList<SeatAvailabilityRS.Service>();
        }
        return services;
    }

    public void setServices(List<SeatAvailabilityRS.Service> services) {
