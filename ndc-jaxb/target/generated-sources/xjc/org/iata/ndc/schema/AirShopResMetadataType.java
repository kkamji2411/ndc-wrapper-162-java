...
public class AirShopResMetadataType {
    ...
    protected AirShopResMetadataType.Traveler traveler;
    @XmlElementWrapper(name = "Other")
    @XmlElement(name = "OtherMetadata", namespace = "http://www.iata.org/IATA/EDIST")
    protected List<AirShopResMetadataType.OtherMetadata> other;
     ...
     * @return
     *     possible object is
     *     {@link AirShopResMetadataType.Traveler }
     *     
     */
    public AirShopResMetadataType.Traveler getTraveler() {
        return traveler;
    }
     ...
     *     
     */
    public void setTraveler(AirShopResMetadataType.Traveler value) {
        this.traveler = value;
    }

    public List<AirShopResMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<AirShopResMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<AirShopResMetadataType.OtherMetadata> other) {
        this.other = other;
    }
