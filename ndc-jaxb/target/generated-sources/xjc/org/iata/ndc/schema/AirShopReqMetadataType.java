...
@XmlSeeAlso({
    org.iata.ndc.schema.AirShoppingRQ.Metadata.class
})
public class AirShopReqMetadataType {
    ...
    protected AirShopReqMetadataType.Traveler traveler;
    @XmlElementWrapper(name = "Other")
    @XmlElement(name = "OtherMetadata", namespace = "http://www.iata.org/IATA/EDIST")
    protected List<AirShopReqMetadataType.OtherMetadata> other;
     ...
     * @return
     *     possible object is
     *     {@link AirShopReqMetadataType.Traveler }
     *     
     */
    public AirShopReqMetadataType.Traveler getTraveler() {
        return traveler;
    }
     ...
     *     
     */
    public void setTraveler(AirShopReqMetadataType.Traveler value) {
        this.traveler = value;
    }

    public List<AirShopReqMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<AirShopReqMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<AirShopReqMetadataType.OtherMetadata> other) {
        this.other = other;
    }
