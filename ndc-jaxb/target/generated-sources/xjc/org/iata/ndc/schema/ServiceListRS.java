 ...
 *           &lt;element name="Parameters" type="{http://www.iata.org/IATA/EDIST}SrvListResParamsType" minOccurs="0"/&gt;
 ...
 *             &lt;complexType&gt;
 *               &lt;complexContent&gt;
 *                 &lt;extension base="{http://www.iata.org/IATA/EDIST}SrvListResMetadataType"&gt;
 *                 &lt;/extension&gt;
 *               &lt;/complexContent&gt;
 *             &lt;/complexType&gt;
 *           &lt;/element&gt;
...
public class ServiceListRS {
    ...
    protected List<ServiceListRS.Service> services;
    ...
    public List<ServiceListRS.Service> getServices() {
        if (services == null) {
            services = new ArrayList<ServiceListRS.Service>();
        }
        return services;
    }

    public void setServices(List<ServiceListRS.Service> services) {
