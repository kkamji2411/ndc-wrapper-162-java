    ...
    extends NoticeBaseType
{
    ...
    public static class TaxExemptionRules {
        ...
        public static class Named {
            ...
            protected List<OrdCreateNoticesType.TaxExemptionRules.Named.TaxCode> taxCodes;
            ...
            public List<OrdCreateNoticesType.TaxExemptionRules.Named.TaxCode> getTaxCodes() {
                if (taxCodes == null) {
                    taxCodes = new ArrayList<OrdCreateNoticesType.TaxExemptionRules.Named.TaxCode>();
                }
                return taxCodes;
            }

            public void setTaxCodes(List<OrdCreateNoticesType.TaxExemptionRules.Named.TaxCode> taxCodes) {
