...
/**
 * Air Shopping Response Message Parameters.
 * 
 * <p>Java class for AirShopResParamsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AirShopResParamsType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AirShopResParamsType", propOrder = {
    "pricing",
    "inventoryGuarantee",
    "group"
})
public class AirShopResParamsType
    extends MessageParamsBaseType
{

    @XmlElement(name = "Pricing")
    protected AirShopResParamsType.Pricing pricing;
    @XmlElement(name = "InventoryGuarantee")
    protected InvGuaranteeType inventoryGuarantee;
    @XmlElement(name = "Group")
    protected AirShopResParamsType.Group group;
     ...
     * @return
     *     possible object is
     *     {@link AirShopResParamsType.Pricing }
     *     
     */
    public AirShopResParamsType.Pricing getPricing() {
        return pricing;
    }
     ...
     *     
     */
    public void setPricing(AirShopResParamsType.Pricing value) {
        this.pricing = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link AirShopResParamsType.Group }
     *     
     */
    public AirShopResParamsType.Group getGroup() {
        return group;
    }
     ...
     *     
     */
    public void setGroup(AirShopResParamsType.Group value) {
        this.group = value;
    }
    ...
    public static class Pricing {
        ...
        protected AirShopResParamsType.Pricing.FeeExemption feeExemption;
         ...
         * @return
         *     possible object is
         *     {@link AirShopResParamsType.Pricing.FeeExemption }
         *     
         */
        public AirShopResParamsType.Pricing.FeeExemption getFeeExemption() {
            return feeExemption;
        }
         ...
         *     
         */
        public void setFeeExemption(AirShopResParamsType.Pricing.FeeExemption value) {
            ...
            extends AssociatedObjectBaseType
        {
            ...
            @XmlElement(name = "Fee")
            protected List<AirShopResParamsType.Pricing.FeeExemption.Fee> fee;
             ...
             * {@link AirShopResParamsType.Pricing.FeeExemption.Fee }
             * 
             * 
             */
            public List<AirShopResParamsType.Pricing.FeeExemption.Fee> getFee() {
                if (fee == null) {
                    fee = new ArrayList<AirShopResParamsType.Pricing.FeeExemption.Fee>();
                }
                return this.fee;
            }
            ...
            public static class Fee {
                ...
                protected AirShopResParamsType.Pricing.FeeExemption.Fee.Code code;
                 ...
                 * @return
                 *     possible object is
                 *     {@link AirShopResParamsType.Pricing.FeeExemption.Fee.Code }
                 *     
                 */
                public AirShopResParamsType.Pricing.FeeExemption.Fee.Code getCode() {
                    return code;
                }
                 ...
                 *     
                 */
                public void setCode(AirShopResParamsType.Pricing.FeeExemption.Fee.Code value) {
                    this.code = value;
                }
