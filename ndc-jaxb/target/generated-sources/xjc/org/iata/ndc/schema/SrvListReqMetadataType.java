...
@XmlSeeAlso({
    org.iata.ndc.schema.ServiceListRQ.Metadata.class
})
public class SrvListReqMetadataType {
    ...
    protected SrvListReqMetadataType.Traveler traveler;
    @XmlElementWrapper(name = "Other")
    @XmlElement(name = "OtherMetadata", namespace = "http://www.iata.org/IATA/EDIST")
    protected List<SrvListReqMetadataType.OtherMetadata> other;
     ...
     * @return
     *     possible object is
     *     {@link SrvListReqMetadataType.Traveler }
     *     
     */
    public SrvListReqMetadataType.Traveler getTraveler() {
        return traveler;
    }
     ...
     *     
     */
    public void setTraveler(SrvListReqMetadataType.Traveler value) {
        this.traveler = value;
    }

    public List<SrvListReqMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<SrvListReqMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<SrvListReqMetadataType.OtherMetadata> other) {
        this.other = other;
    }
