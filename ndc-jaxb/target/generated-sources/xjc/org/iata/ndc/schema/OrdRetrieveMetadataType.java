 ...
 * Metadata definition.
 * 
 * <p>Java class for OrdRetrieveMetadataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OrdRetrieveMetadataType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "OrdRetrieveMetadataType", propOrder = {
    "passengerMetadata",
    "other"
})
public class OrdRetrieveMetadataType {
    ...
    protected List<OrdRetrieveMetadataType.OtherMetadata> other;
    ...
    public List<OrdRetrieveMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<OrdRetrieveMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<OrdRetrieveMetadataType.OtherMetadata> other) {
        this.other = other;
    }
