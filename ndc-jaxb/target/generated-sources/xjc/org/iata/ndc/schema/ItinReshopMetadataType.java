...
public class ItinReshopMetadataType {
    ...
    protected List<ItinReshopMetadataType.OtherMetadata> other;
    ...
    public List<ItinReshopMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<ItinReshopMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<ItinReshopMetadataType.OtherMetadata> other) {
        this.other = other;
    }
