...
public class OrdViewMetadataType {
    ...
    protected List<OrdViewMetadataType.OtherMetadata> other;
    ...
    public List<OrdViewMetadataType.OtherMetadata> getOther() {
        if (other == null) {
            other = new ArrayList<OrdViewMetadataType.OtherMetadata>();
        }
        return other;
    }

    public void setOther(List<OrdViewMetadataType.OtherMetadata> other) {
        this.other = other;
    }
